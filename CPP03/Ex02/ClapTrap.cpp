...
{
    cout << "ClapTrap Copy construcor called" << endl;
    *this = other;
}

ClapTrap &ClapTrap::operator=(const ClapTrap &op_other)
{
    cout << "ClapTrap Copy assignement oeprator called" << endl;
...
{
    cout << this->_name << " take " << amout << " points of damage";
...
void ClapTrap::beRepaired(unsigned int amout)
{
    ...
    {
        cout << this->_name << " not have energy for repaire !" << endl;
        return;
    }
    else
    {
        this->_energyPoints--;
        cout << this->_name << " be repaired of " << amout << " points." << endl;
        this->_hitPoints += amout;
        cout << "Now " << this->_name << " have " << this->_hitPoints << " points." << endl;
        return ;
    }
}